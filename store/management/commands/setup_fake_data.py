...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Addresses data
        print("Adding customers addresses...", end="")
        print("DONE")
        ...
        # Comments data
        print("Adding product comments...", end="")
